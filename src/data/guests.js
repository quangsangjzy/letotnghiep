export const GUESTS = {
  crossing: {
    name: "anh em Crossing",
    displayName: "anh em Crossing",
    group: "Bạn bè",
    greeting: "Thân gửi anh em Crossing,",
    message:
  ...
  "chi-hong": {
    name: "Chị Hồng",
    displayName: "Chị Hồng",
    group: "Bạn bè",
    greeting: "Thân gửi chị gái Hồng Trần,",
    message:
      "Vậy là chị em ta đã chung nhà được 3 năm rùi, trộm vía là giờ mình vẫn đang ở cùng nhau chị nhỉ. Mẹ em chắc cũng yên tâm lắm khi em được ở cùng chị, hay được ăn ké hoa quả các thứ vì chị nhiều tiền mà hehehe. Em Hạnh đã chính thức tốt nghiệp, em sẽ  x10 niềm vui nếu chị có thể đến chụp cùng em 1 tấm ảnh kỷ niệm (em có thuê photographer nha nên chụp là đảm bảo xinh gái) đánh dấu cột mốc kết thúc 4 năm đèn sách của em. ",
  },
  "chi-em-noi-tru": {
    name: "Chị em nội trú",
    displayName: "Chị em nội trú",
    group: "Bạn bè",
    greeting: "Gửi bà Ánh, Huyền Diệp, Phượng, Vi Hằng, Hải Duy ",
    message:
  ...
  "cham": {
    ...
    displayName: "Châm",
    group: "Bạn bè",
    greeting: "Thân gửi Châm xing gái,",
    message:
      "Cuối cùng chị cũng đã tốt nghiệp, thoát khỏi deadline viện D rồi. Châm ở lại chạy deadline vui vẻ ra trường bằng xuất sắc nha. Niềm vui ngày tốt nghiệp sẽ x2 nếu có sự có mặt của em, đến cùng chị chụp 1 tấm ảnh kỷ niệm nha. Tại tòa D quen thuộc, Daver rồi nên cũng không cần dặn dò địa chỉ chỗ gửi xe các thứ nữa.",
  },
  "ngan-duc": {
    name: "Ngân Đức",
    displayName: "Ngân Đức",
    group: "Bạn bè",
    greeting: "Gửi hai em Ngân và Đức, ",
    message:
      "Dù mình mới quen nhao cách đây 1 tháng thui nhưng đã biết bao nhiêu là kỷ niệm với nhau rồi nhỉ. Trộm vía tỷ lần vì chị đã gặp được những người có cùng tần số như thế. Nhân cột mốc chị chuẩn bị làm người lớn, rất mong 2 em iuu có thể đến chụp cùng chị vài bức ảnh kỷ niệm, bận đi làm thì cứ nhắn chị đến muộn cũng được nha. Gặp lại 2 đứa hôm đó nhé! ",
  },
  "minh-anh": {
    name: "Minh Anh ",
  ...
  "anh-nam": {
    name: "Anh Thế Nam",
    displayName: "Anh Thế Nam",
    group: "Bạn bè",
    greeting: "Thân gửi anh Thế Nam đẹp troai, ",
    message:
      "Mới hôm nào đi chúc mưng tốt nghiệp anh Nam giờ em cũng đã được tốt nghiệp rùii. Mời thầy giáo Nam đến chụp cùng em tấm ảnh làm kỷ niệm anh nhé. Cảm ơn anh Nam đã luôn hỗ trợ em về mấy cái công nghệ em ngơ ngơ, em đã thay đổi cái nhìn rất nhiều về anh ý, chứ lúc đầu cũng cũng không ưa lắm đâu hehee. Anh Nam nhớ đến nhé ạ",
  },
  "anh-nam-beo": {
    name: "Nam Nầm",
    displayName: "Nam Nầm",
    group: "Bạn bè",
    greeting: "Gửi anh Nầm, ",
    message:
    ...
    group: "Bạn bè",
    greeting: "Gửi anh em F12 VietSeeds nhóm 1, ",
    message:
    ...
    displayName: "Nhóm 1",
    group: "Bạn bè",
    greeting: "Thân gửi các anh/chị, các bạn và các em một nhà, ",
    message:
...
export const DEFAULT_GUEST = {
  ...
  displayName: "bạn",
  group: "Khách mời",
  greeting: "Thân gửi bạn,",
  message:
    "Hạnh rất vui nếu bạn có thể dành thời gian đến chung vui và lưu lại vài khoảnh khắc trong ngày tốt nghiệp.",
};

export function getGuestFromUrl() {
  const params = new URLSearchParams(window.location.search);
  const id = params.get("guest") || params.get("to") || "crossing";
  ...
  return { id: "default", ...DEFAULT_GUEST };
}
